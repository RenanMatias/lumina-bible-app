        ...
        pericopes: [
          {
            ...
            verses: [
              { number: 1, text: "text Meus filhinhos text Meus filhinhos text" },
              { number: 2, text: "text vós text" },
              { number: 3, text: "text estejais text" },
              { number: 4, text: "text vos text" },
              { number: 5, text: "text Amados text" },
            ],
          ...
          pericopes: [
            {
              ...
              title: "Title Pericope",
              verses: [
                { number: 1, text: `text ${createdUser.firstname} text ${createdUser.firstname} text` },
                { number: 2, text: "text ti text" },
                { number: 3, text: "text estejas text" },
                { number: 4, text: "text te text" },
                { number: 5, text: "text Amado text" },
              ],
              created_at: responseBody.pericopes[0].created_at,
              updated_at: responseBody.pericopes[0].updated_at,
            },
