  ...
  return (
    <>
      <Stack gap="normal" style={{ marginBlock: 50, flex: 1, minWidth: 0 }}>
        <Heading
          as="h2"
          style={{ fontSize: "clamp(1.5rem, 3vw, 1.7rem)", display: "flex", alignItems: "center", gap: 10 }}
        >
          <CommandPaletteIcon size={24} className="text-sky-500" /> <span>O que estamos preparando</span>
        </Heading>
        <FeatureCard
          featured
          icon={CodeOfConductIcon}
          title="Leitura Imersiva"
          description="A Palavra de Deus como você nunca viu. Estamos desenvolvendo uma tecnologia exclusiva de personalização
        ...
        <FeatureCard
          ...
          description="Sua caminhada em grupo, com total privacidade. Crie áreas exclusivas onde você organiza seus próprios
        ...
        <FeatureCard
          ...
          description="Encontre o que precisa em poucos cliques. Desenvolvemos um sistema de busca inteligente por versículos,
